            ...
            try
            {
...

                {
                    ...
                    Assert.Equal(
                        string.Join(
                            "\n",
                            $@"<p sourcefile=""{_inputFolder}/token-a.md"" sourcestartlinenumber=""1"">Standard token.</p>",
                            $@"<p sourcefile=""{_inputFolder}/token-b.md"" sourcestartlinenumber=""1"">Fallback token.</p>",
                            ""),
                        model[Constants.PropertyName.Conceptual]);
                    Assert.Equal(
                        string.Join(
